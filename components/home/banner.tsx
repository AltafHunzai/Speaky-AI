  ...
  return (
    <section className='lg:max-w-6xl mx-auto flex flex-col z-0 items-center justify-center py-28 sm:pt-32 transition-all animate-in'>
      ...
      <Link href={"/#pricing"} className="flex gap-2 items-center" >
        <Button
          variant={"link"}
          className='mt-6 text-xl rounded-full px-12 py-8 lg:mt-20 bg-gradient-to-r from-purple-500
           to-indigo-600 hover:from-indigo-600 hover:to-purple-600 text-white font-bold shadow-lg hover:no-underline'
        >
