...
export default function HowItWorks() {
  return (
    <section className='py-24 relative overflow-hidden'>
      <div
        aria-hidden='true'
        className='pointer-events-none absolute inset-0 -z-10 transform-gpu overflow-hidden blur-3xl -top-24'
      >
        <div
      ...
      <h3 className='flex justify-center items-center mb-24 text-center font-bold'>
